...
export default class Performance
{
    ...
    disablebloom()
    {
        ...
        this.experience.world.garage.neonPink.material = this.materials.lightMatcapMaterial
        this.experience.world.garage.neonBlue.material = this.materials.neonBlueMatcapMaterial
        this.experience.world.garage.neonGreen.material = this.materials.neonGreenMatcapMaterial
        this.experience.world.garage.arcadeRim.material = new THREE.MeshBasicMaterial({color: new THREE.Color('#55FFFF')})
        this.experience.world.garage.poleLight.material = this.materials.lightMatcapMaterial
    ...
    removeReflections()
    {
        if(this.experience.world && this.experience.world.reflections && this.experience.world.reflections.groundMirror)
        {

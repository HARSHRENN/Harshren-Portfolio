...
export default class PostProcessing {
    ...
    setBloomObjects() {
        this.garage.chinese.layers.enable(this.BLOOM_SCENE)
        this.garage.neonBlue.layers.enable(this.BLOOM_SCENE)
        this.garage.neonPink.layers.enable(this.BLOOM_SCENE)
        this.garage.neonYellow.layers.enable(this.BLOOM_SCENE)
        this.garage.neonGreen.layers.enable(this.BLOOM_SCENE)
        this.garage.whiteButton.layers.enable(this.BLOOM_SCENE)
        this.garage.redLED.layers.enable(this.BLOOM_SCENE)
        this.garage.greenLED.layers.enable(this.BLOOM_SCENE)
        this.garage.portalLight.layers.enable(this.BLOOM_SCENE)
        this.garage.storageLight.layers.enable(this.BLOOM_SCENE)
        this.garage.poleLight.layers.enable(this.BLOOM_SCENE)
        this.garage.arcadeRim.layers.enable(this.BLOOM_SCENE)
        this.garage.hologramBase.layers.enable(this.BLOOM_SCENE)
    }
    ...
    setUpBloom() {
        this.renderBloom = function renderBloom() {
            ...
            this.renderer.instance.setClearColor('black')
            this.bloomComposer.render()
            this.renderer.instance.setClearColor('#1E90FF')
